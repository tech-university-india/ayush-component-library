...
interface DropdownProps {
  ...
  headerComponent: (props: { toggleDropdown: () => void; isOpen: boolean }) => React.ReactNode
  className?: string
}
function Dropdown ({ children, headerComponent, className = "" }: DropdownProps) : JSX.Element | null {
